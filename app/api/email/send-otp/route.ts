        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; text-align: center;">
              <h1 style="color: white; margin: 0; font-size: 28px;">TRINCK</h1>
            ...
            <div style="padding: 40px 30px; background: #f8f9fa;">
              ...
              <p style="color: #666; font-size: 16px; line-height: 1.6;">Thank you for registering with TRINCK! Please use the following One-Time Password (OTP) to verify your email address:</p>
              ...
              <p style="color: #666; font-size: 14px; line-height: 1.6;">If you didn't create an account with TRINCK, please ignore this email and no action is required.</p>
            ...
            <div style="background: #333; color: #ccc; text-align: center; padding: 20px; font-size: 12px;">
              <p style="margin: 0;">© 2024 TRINCK Transport & Logistics. All rights reserved.</p>
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 20px; text-align: center;">
              <h1 style="color: white; margin: 0;">TRINCK</h1>
            ...
            <div style="background: #333; color: white; text-align: center; padding: 15px; font-size: 12px;">
              © 2024 TRINCK. All rights reserved.
            </div>
          </div>
        `,
      };
